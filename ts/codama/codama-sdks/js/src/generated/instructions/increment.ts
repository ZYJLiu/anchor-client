...
import { EXAMPLE_PROGRAM_ADDRESS } from '../programs';
...
export type IncrementInstruction<
  TProgram extends string = typeof EXAMPLE_PROGRAM_ADDRESS,
...
export function getIncrementInstruction<
  TAccountCounter extends string,
  TProgramAddress extends Address = typeof EXAMPLE_PROGRAM_ADDRESS,
>(
  input: IncrementInput<TAccountCounter>,
  config?: { programAddress?: TProgramAddress }
): IncrementInstruction<TProgramAddress, TAccountCounter> {
  // Program address.
  const programAddress = config?.programAddress ?? EXAMPLE_PROGRAM_ADDRESS;
